...
def main():
    parser = argparse.ArgumentParser(
        description='ZIBO Keyboard Input Plugin Cross-Platform Build Script',
...
Examples:
    ...
    if not (project_dir / "XPLM-SDK").exists():
        print("Error: XPLM-SDK directory not found")
        return 1
    ...
    if success:
        ...
        if output_file.exists():
            ...
            print(f"  X-Plane/Resources/plugins/ZIBOKeyboardInput/{expected_output}")
