@echo off
REM ZIBO Keyboard Input Plugin Build Script (Windows)
...
echo === ZIBO Keyboard Input Plugin Build Script (Windows) ===
...
if not exist "%PROJECT_DIR%XPLM-SDK" (
    echo Error: X-Plane SDK not found. Please ensure XPLM-SDK directory exists.
    echo The XPLM-SDK should be located at: %PROJECT_DIR%XPLM-SDK
    exit /b 1
)
...
if exist "%XPL_FILE_RELEASE%" (
    ...
    echo   X-Plane\Resources\plugins\ZIBOKeyboardInput\win.xpl
) else (
